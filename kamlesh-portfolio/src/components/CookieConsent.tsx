...
const CookieConsent: React.FC<CookieConsentProps> = ({ onPrivacyClick, onCookiePolicyClick }) => {
  ...
  return (
    <>
      {/* Main Banner */}
      {!showCustomize && (
        <div className="fixed bottom-0 left-0 right-0 z-[9998] bg-white dark:bg-gray-900 border-t-2 border-blue-500 dark:border-blue-600 shadow-2xl">
      ...
      {showCustomize && (
        <div className="fixed inset-0 z-[9999] bg-black/50 backdrop-blur-sm flex items-end sm:items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-900 rounded-t-2xl sm:rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex justify-between items-center rounded-t-2xl">
            ...
            <div className="sticky bottom-0 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-6 py-4 flex flex-col sm:flex-row gap-3 rounded-b-2xl">
              <button
                onClick={handleRejectAll}
