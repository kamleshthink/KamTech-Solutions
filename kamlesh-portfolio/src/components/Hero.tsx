        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 mt-12"
            >
              {[
                {
                  number: '₹50L+',
                ...
                },
                {
                  ...
                  label: 'Active Users',
                  icon: (
                    <svg className="w-10 h-10 mx-auto text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                ...
                },
                {
                  ...
                  label: 'Success Rate',
                  icon: (
                    <svg className="w-10 h-10 mx-auto text-yellow-600 dark:text-yellow-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                ...
                },
                {
                  ...
                  icon: (
                    <svg className="w-10 h-10 mx-auto text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
                    </svg>
                  )
                }
              ].map((stat, index) => (
                <div key={index} className="text-center bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm p-3 sm:p-4 rounded-xl border-2 border-gray-200 dark:border-gray-700 hover:border-primary-400 dark:hover:border-primary-600 transition-all duration-300 hover:scale-105">
