        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mt-10"
            >
              {[
                {
                  value: '₹5.6 Lakh',
                ...
                <div key={index} className="bg-white/90 dark:bg-slate-900/70 border border-slate-200 dark:border-slate-700 p-3 rounded-2xl shadow-lg hover:-translate-y-0.5 transform transition-all duration-300 text-center">
                  <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <div>
                      <div className="text-[11px] font-semibold uppercase text-slate-500 dark:text-slate-400">{stat.label}</div>
                      <div className="text-[10px] text-slate-400 dark:text-slate-500">{stat.description}</div>
                    </div>
                  </div>
                  <div className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">{stat.value}</div>
                  <div className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 mt-1 mb-3">{stat.performance}</div>

                  <div className="h-2 w-full bg-slate-200 dark:bg-slate-800 rounded-full overflow-hidden">
                    <div className={`h-full rounded-full bg-gradient-to-r ${stat.color}`} style={{ width: `${stat.bar}%` }}></div>
                  </div>
