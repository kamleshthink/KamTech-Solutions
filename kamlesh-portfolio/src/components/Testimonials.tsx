...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    feedback: "KamTech Solutions delivered an exceptional AgriTech platform that transformed our business. Within 3 months of launch, we generated ₹18L in revenue and acquired 2,000+ paying customers. The platform handles 500+ daily transactions smoothly. Best investment we made!",
  ...
  },
  {
    ...
    rating: 5,
    feedback: "Our construction website by KamTech Solutions increased our lead generation by 250% in just 2 months. We're getting 50+ qualified inquiries per month now, resulting in ₹12L+ additional revenue. The website paid for itself in the first month!",
  ...
  },
  {
    ...
    company: "BIT Sindri",
    rating: 5,
    feedback: "The ACEBITS community platform reduced our administrative costs by ₹3L annually and improved student engagement by 400%. Now serving 800+ active students with zero downtime. KamTech's post-launch support has been exceptional!",
  ...
  },
  {
    ...
    rating: 5,
    feedback: "Our food delivery app built by KamTech Solutions is processing ₹25L+ monthly transactions. We grew from 0 to 5,000+ users in 4 months with 40% repeat customer rate. The real-time tracking and payment integration work flawlessly!",
  ...
  },
  {
    ...
    rating: 5,
    feedback: "The job portal reduced our hiring time by 60% and saved ₹8L annually on recruitment costs. We're now processing 200+ applications daily with automated screening. KamTech delivered exactly what our business needed!",
